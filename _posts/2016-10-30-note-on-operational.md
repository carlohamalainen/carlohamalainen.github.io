...
and wondered what it would look like using <a href="https://hackage.haskell.org/package/operational">operational</a>. Here we go! 

(Literate Haskell source for this blog post
is <a href="https://github.com/carlohamalainen/playground/tree/master/haskell/note-on-operational">here</a>.) 

First, some imports. We use <a href="https://wiki.haskell.org/GADTs_for_dummies">GADTs</a>
...
using the <a href="https://hackage.haskell.org/package/operational-0.2.3.4/docs/Control-Monad-Operational.html#t:Program">Program</a> constructor: 
...
uses <a href="https://hackage.haskell.org/package/postgresql-simple-0.5.2.1/docs/Database-PostgreSQL-Simple.html">postgresql-simple</a>: 
...
see the <a href="http://packdeps.haskellers.com/reverse/operational">reverse dependencies</a> on Hackage. 
...
Here is the ``ConI`` type from <a href="https://github.com/Soostone/hadron/blob/master/src/Hadron/Controller.hs">Hadron.Controller</a>: 
...
and <a href="https://github.com/Soostone/hadron/blob/8f78faecad49ac0cc35484a70c8b186ae916920b/src/Hadron/Controller.hs#L1022-L1038">lift the NodeIO action</a>. 

### Chart

The <a href="http://hackage.haskell.org/package/Chart-1.8/docs/Graphics-Rendering-Chart-Backend-Impl.html">Graphics.Rendering.Chart.Backend.Impl</a> module
...
Then the <a href="https://hackage.haskell.org/package/Chart-cairo-1.8/docs/Graphics-Rendering-Chart-Backend-Cairo.html">Graphics.Rendering.Chart.Backend.Cairo</a>
...
The <a href="https://hackage.haskell.org/package/redis-resp-0.4.0/docs/Data-Redis-Command.html">Data.Redis.Command</a> module
...
and ``Database.Redis.IO.Client``, an internal module of <a href="https://hackage.haskell.org/package/redis-io">redis-io</a>, defines how
...
The internal module ``Puppet.Interpreter.Types`` of <a href="https://hackage.haskell.org/package/language-puppet">language-puppet</a>
