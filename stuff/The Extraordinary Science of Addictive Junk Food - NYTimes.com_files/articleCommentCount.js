/* $Id: articleCommentCount.js 119325 2013-01-16 00:06:32Z reed.emmons $
...
(function (jQuery) {
    ...
    function buildTemplate(data) {
        ...
        var listOfLinks = [];
        if (data.cite !== false) {
            listOfLinks.push('<li><a href="', data.url, '?permid=', data.permId, '#comment', data.commentId, '" rel="2v">Read Full Comment &#187;</a></li>');
        }
    ...
    function showBlueBox(json) {
        ...
        if (showBox) {
            ...
            var values = {
                ...
                commentId: (excerpt) ? excerpt.commentID : 0,
                cite: false,
                permId: excerpt ? excerpt.permID : 0
            };
